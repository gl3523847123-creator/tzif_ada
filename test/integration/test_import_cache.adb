...
--  Purpose:
--    Unit tests for Import Cache functionality.
--  ======================================================================
with Ada.Text_IO; use Ada.Text_IO;
with Ada.Command_Line;
with Test_Framework;
with TZif.Application.Port.Inbound.Import_Cache;
with TZif.Application.Usecase.Import_Cache;
with TZif.Infrastructure.Adapter.File_System.Repository;
procedure Test_Import_Cache is
   use TZif.Application.Port.Inbound.Import_Cache;
   package UC is new
     TZif.Application.Usecase.Import_Cache.Use_Case
...
begin
   Put_Line ("Test: Import Cache");
   declare
      Result : constant Import_Cache_Result := UC.Execute
          (TZif
             .Application
             .Port
             .Inbound
             .Import_Cache
             .Path_Strings
             .To_Bounded_String ("/tmp/nonexist.cache"));
   begin
      Assert
        (Import_Cache_Result_Package.Is_Ok (Result)
         or else Import_Cache_Result_Package.Is_Error (Result),
