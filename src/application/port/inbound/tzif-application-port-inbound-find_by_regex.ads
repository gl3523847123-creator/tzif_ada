...
--
--  Purpose:
--    Inbound port for Find By Regex use case.
--
--  Architecture:
...
package TZif.Application.Port.Inbound.Find_By_Regex with
  Preelaborate
is
   ...
   --  Regular expression (bounded, max 512 chars)
   ...
   package Find_By_Regex_Result_Package is new Domain.Error.Result
     .Generic_Result
     (T => Unit_Type);
   subtype Find_By_Regex_Result is Find_By_Regex_Result_Package.Result;
...
end TZif.Application.Port.Inbound.Find_By_Regex;
